...
function getHydrationData({
  ...
  let initialMatches = _chunkRVXFVD7Ojs.matchRoutes.call(void 0, routes, location, basename);
  if (initialMatches) {
...
function RSCDefaultRootErrorBoundaryImpl({
  ...
  if (_chunkRVXFVD7Ojs.isRouteErrorResponse.call(void 0, error)) {
    return /* @__PURE__ */ _react2.default.createElement(
      ...
      _chunkRVXFVD7Ojs.ENABLE_DEV_WARNINGS ? heyDeveloper : null
    );
  }
  let errorInstance;
...
function RSCDefaultRootErrorBoundary({
  ...
  let error = _chunkRVXFVD7Ojs.useRouteError.call(void 0, );
